...
async def on_startup():
    ...
    telegram_app.add_handler(MessageHandler(filters.Regex(r"^PF:"), handle_preflop))
    telegram_app.add_handler(MessageHandler(filters.Regex(r"^FLO:"), handle_flop))
    telegram_app.add_handler(MessageHandler(filters.Regex(r"^TUR:"), handle_turn))
    telegram_app.add_handler(MessageHandler(filters.Regex(r"^RIV:"), handle_river))
    telegram_app.add_handler(MessageHandler(filters.Regex(r"^RES:"), handle_result))
